...
describe Credit do
  ...
  describe "factory validation", :factory_validation => true do
    specify { Credit.new.should be_an_instance_of(Credit) }

    describe "credit factory" do
      it_behaves_like "valid record", :credit
    end

    describe "credit_attributes_hash" do
      it "creates new Credit" do
        attributes = FactoryGirl.build(:credit_attributes_hash)
        credit = Credit.create(attributes)
